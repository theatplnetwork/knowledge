...
If your aim is to be employable as a first officer (second in command) at an airline, you'll need either an "fATPL", meaing a CPL(A) with an ATPL theory credit, or an MPL.
